...
namespace Ecole_Coranique.Controllers
{
    public class RevisionsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["HizbId"] = new SelectList(_context.Hizbs, "Id", "Id");
            ViewData["HuitiemeId"] = new SelectList(_context.Huitiemes, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,EtudiantId,HizbId,HuitiemeId")] Revision revision)
        {
            ...
            ViewData["HizbId"] = new SelectList(_context.Hizbs, "Id", "Id", revision.HizbId);
            ViewData["HuitiemeId"] = new SelectList(_context.Huitiemes, "Id", "Id", revision.HuitiemeId);
            return View(revision);
        }
